...
public:
	...
	inline void SetViewParameters(TRHICommandList& RHICmdList, const ShaderRHIParamRef ShaderRHI, const FSceneView& View, const TUniformBufferRef<FViewUniformShaderParameters>& ViewUniformBuffer)
	{
	...
	RENDERER_API void GetShaderBindings(
		...
		const FPrimitiveSceneProxy* ProvenancePrimitiveSceneProxy = nullptr) const;
...
private:
	...
	LAYOUT_FIELD(FShaderUniformBufferParameter, MaterialUniformBufferVS);
