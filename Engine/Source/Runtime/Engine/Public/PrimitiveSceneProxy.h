...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	*/
	...
	inline uint64 GetProvenanceContributorId() const { return ProvenanceContributorId; }
#endif
...
#if RHI_RESOURCE_PROVENANCE_ENABLED
	/** Immutable journal correlation captured before this proxy crosses to the render thread. */
	uint64 ProvenanceContributorId = 0;
#endif
