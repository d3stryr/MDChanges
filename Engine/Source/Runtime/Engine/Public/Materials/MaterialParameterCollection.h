...
enum class EMPCAssetProvenancePhase : uint8
{
	AssetManagerLoadRequest,
	AssetManagerLoadComplete,
	AssetManagerUnload
};
...
public:
	...
	/** Emits targeted Asset Manager provenance into the current default MPC resource generation. */
	ENGINE_API void RecordAssetManagerProvenance(
