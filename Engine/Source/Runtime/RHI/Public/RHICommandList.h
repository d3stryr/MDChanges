...
public:
	...
	inline void UpdateUniformBuffer(FRHIUniformBuffer* UniformBufferRHI, const void* Contents)
	{
		...
		UE::RHI::ResourceProvenance::RecordCommandUse(
			UE::RHI::ResourceProvenance::EOperation::UpdateExecute,
			UniformBufferRHI,
			ProvenanceCommandId,
			ProvenanceCaller);
#endif
	...
	TConstArrayView<FRHIShaderParameterResource> BindlessParameters)
{
	...
	const uint64 CommandId = UE::RHI::ResourceProvenance::BeginCommandUse(
		UE::RHI::ResourceProvenance::EOperation::CommandEnqueue,
		Shader,
		CallerAddress);

	for (const FRHIShaderParameterResource& Parameter : ResourceParameters)
	{
		UE::RHI::ResourceProvenance::RecordCommandUse(
			UE::RHI::ResourceProvenance::EOperation::CommandEnqueue,
			Parameter.Resource,
	...
	for (const FRHIShaderParameterResource& Parameter : BindlessParameters)
	{
		UE::RHI::ResourceProvenance::RecordCommandUse(
			UE::RHI::ResourceProvenance::EOperation::CommandEnqueue,
			Parameter.Resource,
...
inline void RHIRecordShaderParameterCommandExecute(
	FRHIResource* Shader,
	TConstArrayView<FRHIShaderParameterResource> ResourceParameters,
	TConstArrayView<FRHIShaderParameterResource> BindlessParameters,
	uint64 CommandId)
